...
map("t", "<C-b><left>", "<C-\\><C-N><C-w>h", { desc = "Move to left window" })
map("t", "<C-b><down>", "<C-\\><C-N><C-w>j", { desc = "Move to bottom window" })
map("t", "<C-b><up>", "<C-\\><C-N><C-w>k", { desc = "Move to top window" })
map("t", "<C-b><right>", "<C-\\><C-N><C-w>l", { desc = "Move to right window" })
map("t", "<C-b>x", "<C-\\><C-N><C-w>q", { desc = "Close terminal" })
map("t", "<C-w>x", "<C-\\><C-N><C-w>q", { desc = "Close terminal" })

map("n", "<leader>wt", "<cmd>up<cr><cmd>e! term://fish<cr>a", { desc = "Save if applicable, and open terminal" })
map("t", "<esc>", "<C-\\><C-n>", { desc = "Exit terminal mode" })
map("t", "<C-b><left>", "<C-\\><C-N><C-w>ha", { desc = "Move to left window" })
map("t", "<C-w><left>", "<C-\\><C-N><C-w>ha", { desc = "Move to left window" })
...
map("t", "<C-w><down>", "<C-\\><C-N><C-w>ja", { desc = "Move to bottom window from terminal" })
...
map("t", "<C-w><up>", "<C-\\><C-N><C-w>ka", { desc = "Move to top window from terminal" })
...
map("t", "<C-w><right>", "<C-\\><C-N><C-w>la", { desc = "Move to right window from terminal" })
...
map("t", '<C-w>"', "<C-\\><C-N><cmd>sp term://fish<cr>a", { desc = "Split window from terminal" })
...
map("t", "<C-w>%", "<C-\\><C-N><cmd>vs term://fish<cr>a", { desc = "Split window vertically from terminal" })
...
map("t", "<C-w>x", "<C-\\><C-N><C-w>qa", { desc = "Close terminal" })
